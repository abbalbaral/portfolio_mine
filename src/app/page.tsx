        ...
        >
          ...
          <motion.div variants={item} className="md:col-span-2 md:row-span-2 bg-white rounded-3xl p-8 border border-white/60 shadow-xl shadow-slate-200/50 flex flex-col justify-between relative overflow-hidden group">
             ...
             <div className="flex gap-3 mt-8 relative z-10">
               <a href="/Abba_Baral_Resume_for_Internship.pdf" target="_blank" className="flex-1 bg-slate-900 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-slate-800 transition-transform active:scale-95 shadow-lg shadow-slate-900/20">
